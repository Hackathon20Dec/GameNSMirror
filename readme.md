...
- [x] **Maps / Areas (FC):** show different areas (cafe/lobby, coworking floors, 13th floor partial, gym) and move between them.
- [x] **World interactions:** richer map with points/entries (Stardew / Pokémon vibe) using Phaser.
- [x] **GPT NPCs:** scheduled NPC behavior (early MVP: scripted schedules + "seemingly random" movement). NPCs: balaji, jackson, yash, otavio.
